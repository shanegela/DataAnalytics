...
# # run in terminal if running locally to load environment variables
# # source .env

# # sec13f_appkey = environ.get('SEC13F_APPKEY')
# # sec13f_brkcik = environ.get('SEC13F_BRKCIK')
# # # user = environ.get('PSQL_USER')
# # # password = environ.get('PSQL_PWD')
# # # db = environ.get('PSQL_DB')
...
# # 	query_url = "http://edgaronline.api.mashery.com/v2/ownerships/currentownerholdings?ciks=%s&appkey=%s" % (configsec13f_brkcik, sec13f_appkey)
